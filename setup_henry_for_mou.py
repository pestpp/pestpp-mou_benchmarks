...
if __name__ == "__main__":
    ...
    run_mou(risk=0.9,tag="90_single_once",num_workers=30,noptmax=500)
    run_mou(risk=0.9,tag="90_all_once",chance_points="all",num_workers=30,noptmax=500)
    run_mou(risk=0.9,tag="90_all_100th",chance_points="all",recalc_every=100,num_workers=30,noptmax=500)
