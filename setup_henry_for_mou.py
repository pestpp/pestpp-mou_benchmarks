...
if __name__ == "__main__":
    ...
    run_mou(risk=0.9,tag="90_single_once")
    run_mou(risk=0.9,tag="90_all_once",chance_points="all_once")
    run_mou(risk=0.9,tag="90_all_10th",chance_points="all_once",recalc_every=10)
